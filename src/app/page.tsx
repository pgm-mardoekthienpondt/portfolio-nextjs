    ...
    >
      ...
      <footer className="my-24">
        <p className="text-center font-mono text-3xl">
          Website made with NextJS by Mardoek Thienpondt and deployed on Github. You can find the repo <a href='https://github.com/pgm-mardoekthienpondt/portfolio-nextjs'>here</a>.
        </p>
      </footer>
    </div>
  );
